...
const WhatsAppButton = () => {
  ...
  useEffect(() => {
    // Mostrar el popup ocasionalmente (entre 15-30 segundos después de cargar)
    const randomDelay = Math.random() * 15000 + 15000; // 15-30 segundos
    ...
    <>
      ...
      {showPopup && (
        <div className="whatsapp-popup">
          <p>¡Tu consulta no es una molestia! 😊</p>
